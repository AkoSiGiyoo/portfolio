...
const icons = {
  ...
  medical: [{ d: "M9 4.5h6v4h4v6h-4v4h-6v-4H5v-6h4v-4Z" }],
  ...
  shirt: [
    {
      d: "M9 5 12 3l3 2 3 1.5-2 4-2-1V20H10V9.5l-2 1-2-4L9 5Z",
    },
  ],
  certificate: [
  ...
  utensils: [
    { d: "M7 3v8" },
    { d: "M5 3v4a2 2 0 0 0 4 0V3" },
    { d: "M7 11v10" },
    { d: "M16 3c1.8 2 1.8 5 0 7" },
    { d: "M16 10v11" },
    { d: "M14 7h4" },
  ],
  mail: [
  ...
  linkedin: [
    ...
    {
      d: "M10.5 10.5h2.88v1.16h.04c.4-.76 1.38-1.56 2.85-1.56 3.05 0 3.62 2.01 3.62 4.62V19h-3v-3.78c0-.9-.02-2.07-1.26-2.07-1.26 0-1.46.98-1.46 2v3.85h-3z",
      fill: "currentColor",
      strokeWidth: 0,
    },
  ],
  facebook: [
    {
      d: "M13.5 21v-7h2.3l.4-3h-2.7V9.2c0-.87.24-1.46 1.49-1.46H16V5.06c-.2-.03-.9-.08-1.71-.08-1.7 0-2.87 1.04-2.87 2.95V11H9v3h2.42v7",
      fill: "currentColor",
      strokeWidth: 0,
    },
  ],
