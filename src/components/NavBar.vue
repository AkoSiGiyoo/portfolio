<template>
  ...
  >
    <div
      class="mx-auto flex h-16 max-w-6xl items-center justify-between gap-3 px-4 sm:px-5"
    >
      <a
        href="#about"
      ...
      >
        <div
          class="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-[rgba(249,115,22,0.28)] bg-[rgba(249,115,22,0.12)]"
        >
        ...
        <a
          ...
          :class="
            activeSection === link.id
              ? 'text-white border-[rgba(249,115,22,0.28)] bg-[rgba(249,115,22,0.08)]'
              : ''
          "
          @click.prevent="
            scrollTo(link.id);
