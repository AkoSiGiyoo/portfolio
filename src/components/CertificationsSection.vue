  ...
  <div id="certifications" class="card p-6">
    ...
    <div class="space-y-3">
      ...
      >
        ...
        <div class="flex-1">
          <div class="mb-2">
            <h3 class="font-space text-base font-bold text-white">
              {{ cert.title }}
            </h3>
          </div>
          ...
          <div class="mt-2 flex flex-wrap items-center gap-3">
            ...
            <span
              class="font-mono text-[11px] uppercase tracking-[0.18em] text-cyan-300"
            >
              View certificate
            </span>
          </div>
...
const certifications = [
  {
    title:
      "International Conference on Agricultural Research and Innovation (ICARI)",
  ...
  {
    title:
      "The Power of Colors in Graphic Design (Theory, Psychology, and Practice)",
